...
(function () {
  ...
  const DESTINATIONS = {
    ...
    jingdezhen: {
      ...
      sunny: {
        title: '晴稳版 · 吉安出发，瓷都慢游', summary: '三天版集中走城区陶瓷文化；五天版把三宝陶艺和瑶里古镇各留一整天，按能见度与道路情况调整。',
        stops: ['城区日：陶瓷博物馆、陶阳里和古窑按各自预约分日参观', '五天版：三宝与瑶里各一天，瑶里15:00左右返城', '抵达日：傍晚短逛陶溪川；末日午间出发返回吉安市'],
        tips: '天气卡仅代表景德镇城区；吉安与往返沿线、浮梁和瑶里需分别查预报。高温避开正午步行，冬季日短时取消返程日晨游、提前出发。'
      },
      rainy: {
        title: '雨天版 · 预约展馆与弹性返程', summary: '缩短露天步行，五天版取消受预警影响的瑶里与三宝山谷活动；只去已确认开放且道路安全的室内空间。',
        stops: ['上午：按预约进陶瓷博物馆，通常周一闭馆，先核对馆方公告', '下午：已确认开放的陶阳里展陈或市区陶艺课程，无票则酒店休整', '雷雨大风：取消陶溪川露天市集，返吉安前复查沿线预警'],
        tips: '暴雨、雷电、低能见度或山洪地质灾害预警时取消瑶里山路与溪边活动；不进入积水、封闭道路。返程拥堵或疲劳时延后出发或增加住宿，不赶夜路。'
      }
    },
    huizhou: {
      name: '惠州海岸', weatherCity: '441323', weatherLabel: '惠东沿海',
      sunny: {
        title: '晴稳版 · 双湾沙滩与日落线', summary: '把巽寮湾、磨子石和双月湾放在海况稳定的日期，清晨与傍晚优先，正午回到室内休息。',
        stops: ['上午：巽寮湾或双月湾开放沙滩散步玩沙', '傍晚：磨子石开放步道或双月湾观景台看海', '三天版：盐洲岛红树林观鸟与渔村慢游'],
        tips: '晴天不等于适合下水；仍需服从海滩红旗、救生员、潮汐与海况提示，只在开放且有救生管理的水域活动。'
      },
      rainy: {
        title: '风雨版 · 取消涉海与弹性返程', summary: '滨海线不强行做雨天打卡：暂停沙滩、礁石、观景台和出海项目，在酒店或正规餐饮空间休整，待道路安全后提前返程。',
        stops: ['上午：留在住宿内关注惠东预警与景区公告', '中午：选择停车方便、明码标价的正规餐厅', '返程：避开积水与封闭道路，台风或暴雨影响时直接改期'],
        tips: '台风、暴雨、雷电、大风或风暴潮影响期间不靠近海滩、礁石、红树林和观景高处，也不驾车冒险通过深水路段。'
      }
    },
    meizhou: {
